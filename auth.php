...
class auth_plugin_iomademailadmin extends auth_plugin_base {
    ...
    public function process_config($config) {
        ...
        // Save settings.
        set_config('recaptcha', $config->recaptcha, 'auth/iomademailadmin');
        set_config('notif_strategy', $config->notif_strategy, 'auth/iomademailadmin');
        return true;
    }
    ...
    public function send_confirmation_email_support($user) {
        global $CFG, $DB;
        $config = get_config('auth/iomademailadmin');
